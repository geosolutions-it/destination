...
<#assign odd = false>
	...
	<th>${["Type","Tipologia","Tipologia","Typologie"][locale]}</th><td>${["Industry and Services Users/Employees","Utenti/Addetti industria e servizi","Utenti/Addetti industria e servizi","Utenti/Addetti industria e servizi"][locale]}</td> 
