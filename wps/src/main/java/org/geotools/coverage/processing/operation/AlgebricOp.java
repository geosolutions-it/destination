...
import org.geotools.parameter.ExtendedImagingParameterDescriptors;
...
public class AlgebricOp extends OperationJAI {
    ...
    static {
        try {
            ...
            RIFRegistry.register(or, "algebric", "it.geosolutions.jaiext", rif);
        } catch (Exception e) {
    ...
    public AlgebricOp() {
        super(getOperationDescriptor("algebric"), new ExtendedImagingParameterDescriptors(
